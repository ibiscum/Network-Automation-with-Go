...
const (
	OpenConfiggRPC_SubscribeTelemetry_FullMethodName   = "/IOSXRExtensibleManagabilityService.OpenConfiggRPC/SubscribeTelemetry"
	OpenConfiggRPC_UnSubscribeTelemetry_FullMethodName = "/IOSXRExtensibleManagabilityService.OpenConfiggRPC/UnSubscribeTelemetry"
...
func (c *openConfiggRPCClient) SubscribeTelemetry(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (OpenConfiggRPC_SubscribeTelemetryClient, error) {
	stream, err := c.cc.NewStream(ctx, &OpenConfiggRPC_ServiceDesc.Streams[0], OpenConfiggRPC_SubscribeTelemetry_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *openConfiggRPCClient) UnSubscribeTelemetry(ctx context.Context, in *CancelSubscribeReq, opts ...grpc.CallOption) (*SubscribeResponse, error) {
	...
	err := c.cc.Invoke(ctx, OpenConfiggRPC_UnSubscribeTelemetry_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OpenConfiggRPC_UnSubscribeTelemetry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OpenConfiggRPC_UnSubscribeTelemetry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
